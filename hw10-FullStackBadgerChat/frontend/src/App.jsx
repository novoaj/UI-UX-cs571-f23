...
function App() {
  ...
  const handleDelete = (messageId) => {
    console.log(`deleting ${messageId} message...`)
    // post request to backend which will handle DB interaction to delete the message
    fetch("http://localhost:53706/api/messages/:messageId", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json"
      },
